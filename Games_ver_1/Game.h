...
private:
    ...
    void initializePlayers() {
        ...
        players = {
                GameObject(PLAYER_RADIUS, "Images/bird_1.png", sf::Vector2f(WINDOW_WIDTH / 2-170, WINDOW_HEIGHT - 170), textureManager),
                GameObject(PLAYER_RADIUS, "Images/bird_1.png", sf::Vector2f(WINDOW_WIDTH / 2-70, WINDOW_HEIGHT - 170), textureManager),
                GameObject(PLAYER_RADIUS, "Images/bird_1.png", sf::Vector2f(WINDOW_WIDTH / 2+30, WINDOW_HEIGHT - 170), textureManager),
                GameObject(PLAYER_RADIUS, "Images/bird_1.png", sf::Vector2f(WINDOW_WIDTH / 2+130, WINDOW_HEIGHT - 170), textureManager)
        };
    }
    ...
    void launchPlayer(const sf::Vector2f& mousePos) {
        if (selectedPlayerIndex >= 0 && selectedPlayerIndex < players.size()) { //添加越界检查
    ...
    void updateMessage() {
        ...
        playerCountText.setString(L"剩余次数： " + std::to_wstring(players.size() - hadshoot));
    ...
    void renderEndScene() {
        ...
        archiveView.setString(L"按 V 键查看存档"); // 更清晰的中文提示
